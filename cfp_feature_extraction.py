...
def cfp_process(fpath, ypath=None, csv=False, sr=None, hop=80, model_type='vocal'):
    ...
    if 'vocal' in model_type:
        Z, time, CenFreq, tfrL0, tfrLF, tfrLQ = feature_extraction(y, sr, Hop=hop, StartFreq=31.0, StopFreq=1250.0,Window=768,
                                                                   NumPerOct=60)
    if 'melody' in model_type:
        Z, time, CenFreq, tfrL0, tfrLF, tfrLQ = feature_extraction(y, sr, Hop=hop, StartFreq=20.0, StopFreq=2048.0,Window=768,
                                                                   NumPerOct=60)
...
# add mapping function to map from freq to index
...
# W, _, _=cfp_process('abjones_1_01.wav',sr=8000)
# print(W)